...
if False:
  ...
  DATABASE_NAME = os.path.join(os.path.dirname(os.path.abspath(__file__)),'cardsuperdb.sqlite3')             # Or path to database file if using sqlite3.
  ...
  DATABASE_NAME = 'superlatives'             # Or path to database file if using sqlite3.
